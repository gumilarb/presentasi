...
<table calss="table-list" width="650" border="0" cellspacing="1" cellpadding="3">
  <tbody>
    ...
    <tr>
      <td>Keterangan</td>
      <td>:</td>
      <td><label for="textKeterangan"></label>
      <textarea name="textKeterangan" id="textKeterangan" cols="70" rows="6"><?php echo $dataKeterangan;?></textarea></td>
    </tr>
    <tr>
      <td>Kategori</td>
      <td>:</td>
